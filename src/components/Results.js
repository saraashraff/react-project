...
class Results extends Component {
  ...
  //Search function for the searchartist component
  ...
  //Submit the query input in the searchartist component
      ...
      <div className="Results">
        ...
        {  //shows the number of result(s) received from the search
          this.state.enterPressed ?
            <div className="totalEvents"> <strong >{this.state.length}</strong> result(s) found for <strong>"{this.state.search}"</strong> </div>
            :
            <div></div>
        }
        ...
        {   //shows the artist's data
          ...
          this.state.activeResults ?
            <div className="artistTop">
              <div className="artist-container d-flex justify-content-center">
                <div className="result-box ">
                  <div className="column-left">
                    <img className="photo" src={this.state.artistPhoto} />
                  </div>
                  <div className="column-right">
                    <p className="name color">{this.state.artistName}</p>
        ...
        {   //shows the artist's upcoming events' data
          ...
          this.state.eventSearch ?
            ...
            <div></div>
        } <div className="events-container d-flex justify-content-center">
